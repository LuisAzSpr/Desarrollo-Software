...
public class Stepdefs {
    ...
    // fail
    @When("^test_int ((?:\\d+y\\d+)|(?:\\d+k)|(?:\\d+\\.\\d+)|(?:\\d+ and more))$")
    public void test_int_fail(String arg1) throws Throwable {
        System.out.println("test_int false for: " + arg1);
    }
    ...
    // fail
    @When("^test_float ((?:\\d+)|(?:\\d+\\.\\d+ and more))$")
    public void test_float_fail(String arg1) throws Throwable {
        System.out.println("test_float false for: " + arg1);
    }
    ...
    // SEE NOTE 3 :)
    /*
    @When("^test_ip_address ((?:[0-256]\\.){3}(?:\\d{4}))(:? and more)?$")
    public void test_ip_address(String arg1) throws Throwable {
        System.out.println("test_ip_address true for: " + arg1);
    }*/

    // acepta IPs en el rango correcto (de 0 a 256) para cada uno...
    @When("^test_ip_address (((?:(?:\\d{1,2})|(?:1\\d{2})|(?:2[0-5][0-6]))\\.){3}(?:(?:\\d{1,2})|(?:1\\d{2})|(?:2[0-5][0-6])))$")
    public void test_ip_address(String arg1) throws Throwable {
        System.out.println("test_ip_address true for: " + arg1);
    }


    @When("^test_ip_address ((?:\\d{3}\\.\\d{2}\\.\\d{2})|" +
            "(?:four score and \\d{1,3}\\.\\d{1,3}\\.\\d+\\.\\d{1,3})|" +
            "(?:(?:\\d{1,3}\\.){3}(?:\\d{1,3}) and more))?$")
    public void test_ip_address_fail(String arg1) throws Throwable {
        System.out.println("test_ip_address true for: " + arg1);
    }

    /*
    @When("^test_ip_address (\\d)$")
    public void test_ip_address_fail(String arg1) throws Throwable {
        System.out.println("test_ip_address false for: " + arg1);
    }*/
